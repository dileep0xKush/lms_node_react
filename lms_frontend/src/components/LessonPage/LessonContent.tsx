  ...
  return (
    <article className="prose prose-slate max-w-none">
      ...
      <p>
        ...
        describes the structure of a webpage using elements and tags.
      </p>
    ...
    <p>This is my first HTML page.</p>
      ...
      <div className="not-prose my-6 rounded-xl bg-slate-100 p-5">
        ...
        <p className="text-slate-700">
          The <code>&lt;h1&gt;</code> tag defines a heading, and the{" "}
      ...
      <div className="not-prose my-8 rounded-xl bg-green-50 border border-green-200 p-5">
        ...
        <p className="text-slate-700">
          HTML provides the basic structure of a webpage and is the first
          technology you should learn in web development.
        </p>
      </div>
    </article>
  );
